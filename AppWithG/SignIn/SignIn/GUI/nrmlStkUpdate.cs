...
namespace SignIn
{
    public partial class nrmlStkUpdate : Form
    {
            ...
            if (mainName != null)
            {
                if (subName != null)
                {
                    ...
                    if (price2 > 0)
                    {
                        ...
                        numprcStk.Value = 0;
                        lblStkk.Visible = true;
                        comboxsubStk.Items.Clear();
                    }
                    else
                    {
        ...
        private void comboxsubStk_SelectedIndexChanged(object sender, EventArgs e)
        {
            pnlErrSubS.Visible = false;
        }

        private void numprcStk_ValueChanged(object sender, EventArgs e)
        {
