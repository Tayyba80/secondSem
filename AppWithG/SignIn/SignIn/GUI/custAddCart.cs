                            ...
                            for (int j = 0; j < cust.cart.Count; j++)
                            {
                                if (cust.cart.Count != 0)
                                {
                                    ...
                                    if (subName == cust.cart[j].OrderName) /// obj make
                                    {
                                        ...
                                        comboxsub.Text = null;                                                               //  adminDL.menuThngPrc[tempa - 1].AmountCart = adminDL.menuThngPrc[tempa - 1].AmountCart - numberOfbuyingItema;
                                        comBoxM.Text = null;
                                        numprc.Value = 0;
                                        lblCommonErr.Text = "Item added successfully!";
